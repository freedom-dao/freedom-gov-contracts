...
contract GovernorAlpha {
    ...
    string public constant name = "Freedom DAO Governor Alpha";

    /// @notice The number of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    function quorumVotes() public pure returns (uint) { return 25000000e18; } // 25,000,000 = 2.5% of Freedom

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 2500000e18; } // 2,500,000 = .25% of Freedom
    ...
    /// @notice The address of the Freedom Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Freedom governance token
    FreedomInterface public tribe;
